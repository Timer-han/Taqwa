...
QUESITON_REVIEW_MSG = (
    "Вот вопрос и варианты ответа.\n\n"
    "Если полностью согласен, то выбирай <b>Хороший вопрос</b>\n"
    "Если вопрос плохо составлен, выбирай <b>Плохой вопрос</b>\n"
    "Если ты считаешь, что вопрос можно улучшить, выбери <b>Я бы улучшил</b>\n\n"
)
